...
!!$! loading the grid of the pr2 boxes value
!!$open(19,file='/homedata/mreverdy/GOCCP/grilles_lmdz/srmod8')
!!$  do ipr2=1,pr2max
...
open(15,file='/homedata/mreverdy/GOCCP/grilles_lmdz/'//altfile)
    ...
    elseif(alt_pres=='pressure')then
         ...
         elseif(trim(gcm).eq.'NASA')then
            open(15,file='/homedata/mreverdy/GOCCP/grilles_lmdz/pres_cfmip')   
 !           open(15,file='/homedata/mreverdy/GOCCP/grilles_lmdz/altitude_lmdz3')
         endif
            do iz=1,altmax
...
!!$do idiag=1,diagmax-1
!!$   write(idiagc,'(i2)')idiag
!!$print *, '/homedata/mreverdy/GOCCP/'//file8
!!$print *, 'monthdiagSR_Occ'//trim(adjustl(idiagc))
!!$   call rdnc3('/homedata/mreverdy/GOCCP/'//trim(file7)//'.tmp',monthdiagSR1,altmax,lonmax-1,latmax-1,'cfad_lidarsr532_Occ'//trim(adjustl(idiagc)))
!!$print *, 'call rdnc3'
...
!!$command2='rm -f /homedata/mreverdy/GOCCP/'//trim(file7)//'.tmp'
!!$call system(command2)
!!$print *, ''
!!$
...
!!$   call rdnc4('/homedata/mreverdy/GOCCP/'//trim(file10)//'.tmp',monthdepolSR1,altmax,lonmax-1,latmax-1,'cfad_lidardepol532_Occ'//trim(adjustl(idepc)))
!!$print *, 'call rdnc4'
...
!!$
!!$print *, 'rm the diag file'
!!$command2='rm -f /homedata/mreverdy/GOCCP/'//trim(file10)//'.tmp'
!!$call system(command2)
!!$print *, ''
!!$
!!$
